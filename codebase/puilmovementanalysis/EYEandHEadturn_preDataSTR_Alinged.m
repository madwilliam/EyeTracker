...
AlingedData.Headvelocity=NaN(40,800);
AlingedData.Headangle=NaN(40,800);
AlingedData.Eyemovment=NaN(40,800);
AlingedData.Rightwhisker=NaN(40,800);
AlingedData.LeftWhisker=NaN(40,800);
AlingedData.Trialype=NaN(1,40);
a = ones(1,264)*150;
a(20)=94;
a(34)=90;
a(66)=54;
