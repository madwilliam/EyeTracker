...
for Trialnumber =1
    ...
    % Main_Folder = 'F:\ar38\2022_02_08\';
   Main_FolderRight = '\\dk-server.dk.ucsd.edu\afassihizakeri\Leftsidemovies\ar38motor\2022_02_08\';
    thisfilename = ([Main_FolderRight num2str(Trialnumber) 'EYEDLC_resnet50_Eyedata6Feb6shuffle1_300000_filtered.CSV']);
    thisfilename = ([Main_FolderRight num2str(Trialnumber) 'EYEDLC_resnet50_LeftEye_MarchMar3shuffle1_895000.CSV']);
    ...
    tic
    thisminsize = 35;% ar38   thisminsize = 30;

    Maxdevider=510;% ar38     Maxdevider=512;

    Mindevider = 495;%Mindevider = 495;
    thismaxsize = 80;     %thismaxsize = 50;
...
%         end
        ...
        if ind>1
            Maxsize = pupilmaxlenght(ind-1)*1.25;
            minsize = pupilminlenght(ind-1)*0.7;
