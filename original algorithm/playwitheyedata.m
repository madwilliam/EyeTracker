thisfilename = ('F:\ar38\2022_02_08\175EYEDLC_resnet50_Eyedata6Feb6shuffle1_300000_filtered.CSV');
...
thisfilename = ('I:\topview\ar38motor\2022_02_08\176videoDLC_resnet50_Topview3435_FEB22Feb6shuffle1_343000_filtered.CSV');
...
thisfilename = ('F:\ar38\2022_02_08\175DLC_resnet50_Rightside_Feb2022_2Feb8shuffle1_100000_filtered.CSV');
...
optsL = detectImportOptions(thisfilename);
    optsL.VariableNames={'frames', 'x1','y1','L1'...
        ,'x2','y2','L2','x3','y3','L3'};
        %   open tables with DLC whisker files
    Tside = readtable(thisfilename,optsL);
%%
i=60;
hold off
